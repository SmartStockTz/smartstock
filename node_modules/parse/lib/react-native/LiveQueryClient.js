...
import { resolvingPromise } from './promiseUtils'; // The LiveQuery client inner state
      ...
      default:
        {
          ...
          const className = data.object.className; // Delete the extrea __type and className fields during transfer to full JSON
