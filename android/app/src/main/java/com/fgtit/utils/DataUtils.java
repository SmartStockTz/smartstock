...
public class DataUtils {
	...
	/**
	 * 16 hexadecimal string to byte array
	 *
	 * @param hex
	 * @return
	 */
	...
	/**
	 * 16 hexadecimal string to string
	 */
	...
	/**
	 * String to 16 hexadecimal string
	 */
	...
	/**
	 * 16 hexadecimal string to a number of blocks, each of the 32 characters of the 16 binary, that is, the 16 byte
	 *
	 * @param str
	 * @return
	 */
